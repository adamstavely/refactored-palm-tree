...
The mark is two interlocking rounded-square links rotated 38 degrees. It reads as connected capabilities held in one place, which is the registry's job.
...
Clear space: keep padding around the mark equal to one ring's corner radius. Do not recolor the mark outside the tokens above, do not add a third tone, and do not change the 38 degree angle.
